...
const FeaturedFoods = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto py-12 mb-20 ">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        ...
        <div className="hidden sm:flex gap-2">
          <button
            ...
            className={`p-2 rounded-full border-2 ${columns === 2
          ...
          <button
            ...
            className={`p-2 rounded-full border-2 ${columns === 3
              ? "bg-orange-500 text-white border-orange-500"
              : "bg-white dark:bg-[#393053] text-orange-500 border-orange-500"
              } transition`}
      ...
      {loading ? <div className="text-center flex justify-center py-20"><span className="loading loading-spinner text-secondary"></span></div>
          : 
